        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-6 md:mb-8">
            ...
            <button
              ...
              className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors text-sm sm:text-base w-full sm:w-auto"
            >
              Logout
            </button>
          </div>

          <div className="bg-gray-800/50 rounded-lg p-6 md:p-8 space-y-6">
            {/* Username Section */}
            <div>
